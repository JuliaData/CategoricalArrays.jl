...
JSON3.StructTypes.StructType(::Type{<:CategoricalValue{<:Symbol}}) = JSON3.StructTypes.StringType()
JSON3.StructTypes.StructType(::Type{<:CategoricalValue{<:Number}}) = JSON3.StructTypes.NumberType()
